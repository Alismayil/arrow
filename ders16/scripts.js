...
//     return num1/num2
// }
// function end(num1,num2,callback) {
//     return callback(num1,num2)
// }
// console.log(end(6,3,toplama));
...
// }
// console.log(end(bolme,12,1,1,1,4));
...
//     }
// }
// console.table(findlook);

// ----------------------------------

// usul2
// const tapilan = arr.find(x=>x.name === "Spegesild" )
// console.log(tapilan);

// -----------------------------------------------------------------------

// function salamla(name="oglan") {
...
// const sum = (a, b)=> a+b
// // arrow2
// const salamla = name => console.log(name);
...
// arrow
// const deger = (ad, soyad)=> ( "salam "+ ad + soyad)
// console.log("ali" , "ismayil")

// expression
// const deger = function (ad , soyad){
//     console.log("salam "+ ad + soyad)
// }
// deger("Ali"," Ismayil")
